  ...
  return (
    <div className="max-w-7xl mx-auto p-8 space-y-12">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-6xl font-black text-foreground">Kiosk Style Guide</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          A comprehensive design system for touch-friendly retail kiosk interfaces
        </p>
      </div>
        ...
        <Card className="p-8">
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">Font: Geist Sans Black, 60px</p>
            </div>
            <div className="space-y-2">
              <h2 className="text-4xl font-black text-foreground">Heading 2</h2>
              <p className="text-muted-foreground">Font: Geist Sans Black, 36px</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-foreground">Heading 3</h3>
              <p className="text-muted-foreground">Font: Geist Sans Bold, 24px</p>
            </div>
            <div className="space-y-2">
              <p className="text-lg text-foreground leading-relaxed">
                Body text for kiosk interfaces should be highly readable and accessible. This text uses a comfortable
                line height and sufficient contrast.
              </p>
              <p className="text-muted-foreground">Font: Geist Sans Regular, 18px</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">Small text for secondary information</p>
              <p className="text-muted-foreground">Font: Geist Sans Regular, 14px</p>
            </div>
          </CardContent>
        </Card>
      </section>
        ...
        <Card className="p-8">
          <CardContent className="space-y-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Primary Buttons</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Secondary Buttons</h3>
              <div className="flex flex-wrap gap-4">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Icon Buttons</h3>
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant="outline" size="lg" className="h-16 w-16 bg-transparent">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <CardHeader className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-accent text-accent-foreground text-sm px-3 py-1">New</Badge>
              </div>
          ...
          <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-xl text-center">Electronics</CardTitle>
                <Badge variant="outline" className="text-sm px-3 py-1 border-2">
                  Popular
                </Badge>
              </div>
              <CardDescription className="text-center text-lg">Browse our latest tech products</CardDescription>
            </CardHeader>
          </Card>
      ...
      <section className="space-y-6">
        ...
        <Card className="p-8">
          <CardContent className="space-y-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Primary Tags</h3>
              <div className="flex flex-wrap gap-4">
                <Badge className="bg-primary text-primary-foreground text-lg px-4 py-2 h-auto">Best Seller</Badge>
                <Badge className="bg-accent text-accent-foreground text-lg px-4 py-2 h-auto">New Arrival</Badge>
                <Badge className="bg-destructive text-destructive-foreground text-lg px-4 py-2 h-auto">Sale</Badge>
                <Badge className="bg-primary text-primary-foreground text-lg px-4 py-2 h-auto">Featured</Badge>
              </div>
            </div>

            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Outline Tags</h3>
              <div className="flex flex-wrap gap-4">
                <Badge
                  variant="outline"
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Secondary Tags</h3>
              <div className="flex flex-wrap gap-4">
                <Badge variant="secondary" className="bg-secondary text-secondary-foreground text-lg px-4 py-2 h-auto">
                  In Stock
                </Badge>
                <Badge variant="secondary" className="bg-secondary text-secondary-foreground text-lg px-4 py-2 h-auto">
                  Free Shipping
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge className="bg-primary text-primary-foreground text-sm px-3 py-1">New</Badge>
                <Badge className="bg-accent text-accent-foreground text-sm px-3 py-1">Hot</Badge>
                <Badge variant="outline" className="border-2 text-sm px-3 py-1 bg-transparent">
                  Sale
                </Badge>
                <Badge variant="secondary" className="text-sm px-3 py-1">
                  Gift
                </Badge>
                <Badge className="bg-destructive text-destructive-foreground text-sm px-3 py-1">50% Off</Badge>
              </div>
            </div>

            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Category Tags</h3>
              <div className="flex flex-wrap gap-4">
                <Badge
                  variant="outline"
                  className="border-2 border-primary text-primary text-lg px-4 py-2 h-auto bg-transparent"
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Status Tags</h3>
              <div className="flex flex-wrap gap-4">
                <Badge className="bg-primary text-primary-foreground text-lg px-4 py-2 h-auto">Available</Badge>
                <Badge className="bg-accent text-accent-foreground text-lg px-4 py-2 h-auto">Low Stock</Badge>
                <Badge variant="secondary" className="bg-muted text-muted-foreground text-lg px-4 py-2 h-auto">
                  Out of Stock
                </Badge>
      ...
      <section className="space-y-6">
        ...
        <Card className="p-8">
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Standard Pagination</h3>
              <div className="flex items-center justify-center space-x-2">
                <Button variant="outline" size="lg" className="h-14 w-14 bg-transparent">
                  <ChevronLeft className="h-6 w-6" />
                </Button>
                <Button variant="outline" size="lg" className="h-14 px-6 bg-transparent">
                  1
                </Button>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Simple Navigation</h3>
              <div className="flex items-center justify-center space-x-4">
                <Button variant="outline" size="lg" className="text-lg px-8 py-4 h-auto bg-transparent">
                  <ChevronLeft className="mr-2 h-6 w-6" />
                  Previous
                </Button>
                <span className="text-lg text-muted-foreground px-4">Page 2 of 10</span>
                <Button size="lg" className="text-lg px-8 py-4 h-auto">
                  Next
      ...
      <section className="space-y-6">
        ...
        <Card className="p-8">
          <CardContent className="space-y-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Primary Icons (48px)</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Secondary Icons (32px)</h3>
              <div className="grid grid-cols-4 md:grid-cols-8 gap-6">
                <div className="flex flex-col items-center space-y-2">
      ...
      <section className="space-y-6">
        ...
        <Card className="p-8">
          <CardContent className="space-y-8">
            {/* Text Fields */}
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Text Fields</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="disabled" className="text-lg font-semibold text-muted-foreground">
                    Disabled Field
                  </Label>
                  <Input
                    id="disabled"
            ...
            {/* Radio Buttons */}
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Radio Buttons</h3>
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      defaultChecked
                    />
                    <Label htmlFor="warranty" className="text-lg cursor-pointer">
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="h-6 w-6 text-primary border-2 border-border rounded focus:ring-primary focus:ring-2"
                    />
                    <Label htmlFor="installation" className="text-lg cursor-pointer">
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="h-6 w-6 text-primary border-2 border-border rounded focus:ring-primary focus:ring-2"
                    />
                    <Label htmlFor="newsletter" className="text-lg cursor-pointer">
            ...
            {/* Error States */}
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Error States</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="error-email" className="text-lg font-semibold">
                    Email Address
                  </Label>
                  <Input
                    id="error-email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="success-phone" className="text-lg font-semibold">
                    Phone Number
                  </Label>
                  <Input
                    id="success-phone"
            ...
            {/* Form Example */}
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Complete Form Example</h3>
              <Card className="p-6 bg-secondary/50">
                ...
                <CardContent className="px-0 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="form-email" className="text-lg font-semibold">
                        Email Address *
                      </Label>
                      <Input
                        id="form-email"
                    ...
                    <div className="flex flex-wrap gap-6">
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          defaultChecked
                        />
                        <Label htmlFor="contact-email" className="text-lg cursor-pointer">
                          Email
                        </Label>
                      </div>
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          className="h-6 w-6 text-primary border-2 border-border focus:ring-primary focus:ring-2"
                        />
                        <Label htmlFor="contact-phone" className="text-lg cursor-pointer">
                          Phone
                        </Label>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      required
                    />
                    <Label htmlFor="form-terms" className="text-lg cursor-pointer">
                      I agree to the terms and conditions *
                    </Label>
                  </div>
      ...
      {/* Usage Guidelines */}
      <section className="space-y-6">
        <h2 className="text-4xl font-black text-foreground">Usage Guidelines</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-primary/5 border-primary/20">
            <CardHeader>
              <CardTitle className="text-xl text-primary">Touch Targets</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <p className="text-foreground">• Minimum 48px × 48px for all interactive elements</p>
              <p className="text-foreground">• 8px spacing between touch targets</p>
              <p className="text-foreground">• Large buttons for primary actions</p>
              <p className="text-foreground">• Clear visual feedback on interaction</p>
            </CardContent>
          </Card>

          <Card className="bg-accent/5 border-accent/20">
            <CardHeader>
              <CardTitle className="text-xl text-accent">Accessibility</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <p className="text-foreground">• High contrast ratios (4.5:1 minimum)</p>
              <p className="text-foreground">• Large, readable typography</p>
              <p className="text-foreground">• Clear visual hierarchy</p>
              <p className="text-foreground">• Consistent interaction patterns</p>
            </CardContent>
          </Card>
        </div>
      </section>
